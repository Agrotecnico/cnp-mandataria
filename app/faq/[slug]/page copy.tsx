...
import FormComment from '@/app/ui/consultas/comments/xxxform-comment';
...
import ListCommentAvatar from '@/app/ui/consultas/comments/xxxlist-comment-avatar';
    ...
    <>
      <Frente className="!rounded-lg !bg-[#ffffffaa] ">
        <article className="px-3 pb-6 pt-6 md:px-6">
          ...
          <div className="mx-auto mb-9 max-w-2xl text-sm sm:text-base" >
            <div
