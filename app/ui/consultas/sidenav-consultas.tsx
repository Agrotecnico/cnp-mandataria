...
export default async function SideNavConsultas() {
  ...
  return (
    <div className="hidden h-max flex-col lg:flex lg:fixed">
      <Fondo className="bg-[#548eff16] p-3 lg:w-72">
      ...
      <div className="flex flex-col w-max mx-auto my-12 gap-0.5 text-sm rounded-lg shadow-[0_10px_20px_#020b1d33] sm:text-[15px] sm:mt-12">
        <Link 
          ...
          className="group h-7 flex items-center rounded-t-lg px-3 bg-[#ffffff88] duration-150 justify-start  sm:h-8 hover:bg-white active:opacity-80">
        ...
        <Link 
          ...
          className="group h-7 flex items-center rounded-b-lg px-3 bg-[#ffffff88] duration-150 justify-start  sm:h-8 hover:bg-white active:opacity-80">
          <IconConsulta 
