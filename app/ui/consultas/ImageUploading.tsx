...
import { openFileDialog, getListFiles, getAcceptTypeString } from '@/app/ui/consultas/utils';
import { getErrorValidation } from '@/app/ui/consultas/validation';
import {
  ImageType,
  ImageListType,
...
} from '@/app/ui/consultas/constants';
