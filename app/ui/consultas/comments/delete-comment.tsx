  ...
  return (
    <div className="group flex justify-center gap-4 ">
      <button
        ...
        className="px-2 ml-2 text-xs text-[#200b1dbb] bg-[#ffffffaa] opacity-80 duration-150 rounded-full hover:opacity-100 group-hover:text-[#ffffff] hover:bg-[#39507fcc] "
      >
        eliminar
      </button>
