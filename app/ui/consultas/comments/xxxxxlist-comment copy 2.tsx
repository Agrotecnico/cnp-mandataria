...
export default function ListComment({ 
  ...
  useEffect(() => {
    ...
    // sessionStorage.getItem('commentSession') && sessionStorage.setItem('commentSession', "")
  }, [/* imageUrlxx */]);
  ...
  // const initialStatexxx: StateUpdateComment = { message: null, errors: {} };
  // const updateCommentWithId = updateComment.bind(null, id3 );
  // const [estadoxxx, formActionxxx, isPendingxxx] = useActionState(updateCommentWithId, initialStatexxx);
  ...
  const initialStatex: StateUpdateCommentImage = { message: null, errors: {} };
  const updateCommentImageWithId = updateCommentImage.bind(null, id );
  const [estadox, formActionx, isPendingx] = useActionState(updateCommentImageWithId, initialStatex);

  const updateCommentDeleteWithId = updateCommentDelete.bind(null, id4);
  // const deleteCommentWithId = deleteComment.bind(null, id4);


  console.log("nombre:", name ? name : nombre )
  console.log("comment:", comment)
  console.log("slug:", post.slug)
  console.log("imageUrl:",   imageUrl ? imageUrl : ""  )
  console.log("email:", email ? email : "comment@gmail.com")
  console.log("imgVisitor:", imgVisitor)
            ...
            {({
              ...
              <div className={`flex flex-col `} >
                ...
                {/* <div className= "flex flex-col items-start rounded-b-lg"> */}
                  ...
                  {/* <div className= {`flex items-baseline justify-start gap-x-2 flex-wrap ${images.length ? "mt-0" : "pt-0"} text-sm w-full cursor-default max-[512px]:justify-center sm:gap-x-4 `}> */}
                      ...
                      <div className="w-full flex flex-col justify-start gap-4">
                        <div className={` ${images.length ? "hidden" : "flex" } ml-2 text-[13px] items-center justify-start gap-5 `}>
                          ...
                          {/* <button 
                            ...
                            className="hidden items-center gap-3 h-6 bg-[#39507f] text-[#ffffff] px-3 py-0.5 cursor-pointer rounded-[4px] duration-200 opacity-80 hover:opacity-100 active:opacity-70 "
                            // disabled= {!files.length}
                            >
                            Salir
                          </button> */}
                        ...
                        <div className={` ${images.length ? "flex" : "hidden"} text-[13px] items-center justify-start gap-[1px] `}>
                          ...
                          {/* <button 
                            ...
                            className="hidden items-center gap-1.5 h-8 bg-[#ffffff] text-[#020b1daa] px-2 py-0.5 cursor-pointer rounded-r-md duration-200 hover:text-[#020b1dee] active:opacity-70 disabled:opacity-40 disabled:cursor-default"
                            disabled= {!files.length}
                            >
                          ...
                          <form onSubmit={ uploadToServer2 } >
                            <div className="relative flex justify-end gap-3 mb-0.5 ml-2 ">
                              <button
                                ...
                                className={`${ spin && "before:absolute before:inset-0 before:-translate-x-full before:animate-[shimmer_1s_infinite] before:bg-gradient-to-r before:from-transparent before:via-white/30 before:to-transparent"}  relative overflow-hidden  px-2 h-5 flex items-center text-sm text-[#fff] border border-transparent bg-[#4281fd] opacity-80 duration-150 rounded-[4px] hover:opacity-100 disabled:cursor-default disabled:opacity-60 `}
            ...
            <div className="flex-grow">
              <div className="flex items-center justify-between">
                <div className="flex flex-wrap">
                  ...
                  <time className="text-[#020b1d66] text-sm">
                    hace 3 segundos
                  </time>
                </div>
                <div className='relative flex items-center gap-0'>
                  <DeleteComment id={commentLast.id} />
                </div>
              </div>
              <div className=" mt-1 leading-relaxed">
                {comment ? comment : <span className='text-transparent'>C</span> }
              </div>
            </div>
          </Fondo> */}
          {/* </div> */}
        ...
        <div className='relative '>
          {comments &&
            comments.map((comment, index) => {
              ...
              const isVisitor=  nameVisitor === comment.nombre 

              return (
                <div key={index} className={`flex flex-col mb-3 gap-[2px]`}>{/*  ${index == 0 && sessionStorage.getItem("commentSession") === comment.comment && "hidden"} */}

                 {/* <div key={index} className={`flex flex-col mb-3 gap-2 ${index == 0 && !sessionStorage.getItem("imgVisitor") && "hidden"}`}> */}
                    ...
                    <div className="flex-grow">
                      <div className="flex items-center justify-between">
                        ...
                        <div className='relative flex items-center gap-0'>
                          ...
                          {/* { (isAdmin || isAuthor || isVisitor ) && index === 0 ? (
                            <DeleteComment id={commentLast.id} />
                          ) : (isAdmin || isAuthor || isVisitor ) && index !== 0 && (
                            <UpdateComment id={comment.id} comme={comme} />
                          )} */}
                          { (isAdmin || (isAuthor || isVisitor) /*&&  index === 0 && !commentSession  */) && (
                            <UpdateComment id={comment.id} comme={comme} index={index} />
                          ) /* : (isAdmin || (isAuthor || isVisitor) && index === 0 && commentSession ) ? (
                            ""
                          ) : ""*/  }   
                          <form 
                            action={updateCommentDeleteWithId}
                            ...
                            <button
                              ...
                              className={`${comme === false && index === 0 ? "block" : "hidden"} px-2 ml-2 text-xs text-[#200b1dbb] bg-[#ffffffaa] opacity-80 duration-150 rounded-full hover:opacity-100 hover:text-[#ffffff] hover:bg-[#39507fcc] disabled:opacity-50 disabled:bg-[#ffffffaa] disabled:hover:text-[#20021bbb] `}
                            >
                              eliminarxx
                            </button>
                          </form>
        ...
        <form action={formAction}>
          <div className="hidden flex-col text-sm justify-center gap-3 ml-2 ">
            ...
            <input
              ...
              id="avatar"
              name="avatar"
              // value= "https://res.cloudinary.com/dchmrl6fc/image/upload/v1746358221/amy-burns_yqljpt.png"
        ...
        <form action={formActionx} className="w-full">
          ...
          <div className="hidden">
            <input
              ...
              // value="https://res.cloudinary.com/dchmrl6fc/image/upload/v1757261641/gjp0vyocywmduzjoo9jq.png"
              value= {imageUrl ? imageUrl : "" }
            />
            <input
              type="hidden"
