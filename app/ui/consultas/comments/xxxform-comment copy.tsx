    ...
    <>
      <div className={` ${commentOk === true ? "block" : "hidden"}`}>
        <p className={` text-sm sm:text-[15px]  `}>
          <span className="font-semibold text-[15px] mr-1.5 sm:text-base">
          ...
          >
            ...
            <div className="" > 
              ...
              <fieldset className="grid grid-cols items-center gap-2 sm:grid-cols-2 md:flex-row md:gap-4">
                { !user  /*|| user?.role !== "memberAccount" */ /* !sessionStorage.getItem('nombre') */ && (
                  <InputCnp
              ...
              <TextareaCnp
                ...
                name="comment"
                // className={`text-sm placeholder:text-[#000000aa] placeholder:text-[13px] ${open === false ? "hidden" : "block"} `}
                className={`text-sm placeholder:text-[#000000aa] placeholder:text-[13px]  ${!open && "invisible"}`}
                rows={3}
                placeholder={`Comentario...`}
                value={comment}
                onChange={(e) => setComment(e.target.value)}
            ...
            <form action={formAction}>
              ...
              <div className={`flex items-center justify-end gap-4 mt-4 text-sm  ${!open && "invisible"}`}>{/*  ${open === false ? "invisible" : "visible"} */}
                ...
                {user ? (
                  ...
                  <ButtonA
                    type="button"
                    className={`h-8 text-[13px] w-max  ${!open && "invisible"}`}
      ...
      <div className={`gap-2 flex flex-col sm:flex-row ${comme === true && "hidden" }`}>
        <div className="flex-shrink-0">
          <div className="flex h-10 w-10 items-center text-[#39507fcc] justify-center rounded-full bg-[#020b1d18] text-2xl ">
              ...
              <form action={formAction}>
                <div className="flex justify-center gap-3 ml-2 ">
                  ...
                  <button
                    ...
                    className="px-2 h-5 flex items-center text-sm text-[#fff] border border-transparent bg-[#548eff] opacity-80 duration-150 rounded-full hover:opacity-100 "
                  >
                    enviar
                  </button>
                  <button
                    ...
                    className="px-2 h-5 flex items-center text-sm text-[#fff] border border-transparent bg-[#39507f] opacity-80 duration-150 rounded-full hover:opacity-100"
                  >
                    eliminar
                  </button>
                </div>
