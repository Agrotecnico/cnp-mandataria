...
export default function UserButtonHeader( { user }: { user: User | undefined } ) {
  ...
  useEffect(() => {
    // user && user.image ? setImageSrc(user.image) : setImageSrc(null);
    ...
    const data2= sessionStorage.getItem('nombre')
    setNombre(data2)
  ...
  // console.log('imgVisitor:', imageSrc);
    ...
    <div className='flex items-center justify-end space-x-4'>
      {user ? (
        <DropdownMenu>
          <DropdownMenuTrigger >
            <div className='relative flex items-center justify-center '>
              ...
              /* ) : (
                <div className="flex items-center justify-center w-10 h-10 bg-[#ffffff00] rounded-full opacity-70 hover:opacity-90 duration-150">
          ...
          >
            ...
            <DropdownMenu>
              {/* <DropdownMenuTrigger asChild> */}
                ...
                >
                  <div className="w-full px-2 py-1 rounded-md text-[#374151] ">Actualizar <span  className='text-[13px] font-medium text-[#39507f]'>DIRECCIÓN ENVIO</span></div>{/* hover:bg-[#37415111]  hover:opacity-100  opacity-[0.85]*/}
                </Button>
              {/* </DropdownMenuTrigger> */}
            ...
            <DropdownMenu>
              {/* <DropdownMenuTrigger asChild> */}
                <Button
                  ...
                  className="relative gap-4 h-8 w-full cursor-default !font-normal text-start rounded-full px-0 opacity-50"
                >
                  <div className="w-full px-2 py-1 rounded-md text-[#374151] ">Cargar <span  className='text-[13px] font-medium text-[#39507f]'>INFORMACIÓN PERSONAL</span></div>{/* hover:bg-[#37415111]  hover:opacity-100  opacity-[0.85]*/}
                </Button>
              {/* </DropdownMenuTrigger> */}
        ...
        <DropdownMenu>
          ...
          <DropdownMenuTrigger >{/* imageSrc || imgUserSession */}
            <div className={`relative items-center justify-center ${nombre ? "flex" : "hidden" }`} >
              {/* {imageSrc ? ( */}
                {sessionStorage.getItem('imgVisitor') ? (
                <>
                {/* {imgUserSession ? ( */}
                
                  <Image 
                    // src= { imgUserSession }
                    src= { `${sessionStorage.getItem('imgVisitor')}` }
                    // src= { avatar }
                    alt="imagen de perfil"
                    className="h-10 w-10 rounded-full "
                    width={40}
          ...
          <div className={`items-center justify-center w-10 h-10 bg-[#ffffff00] rounded-full opacity-60  ${ nombre ? "hidden" : "flex" } `}>{/* hover:opacity-90 duration-150 */}
            <IconCuenta className="w-7 sm:w-8" color='#ffffffdd' />{/* imageSrc && imgUserSession */}
          </div>
        ...
        >
              ...
              <DropdownMenuItem>
                <div className="group relative cursor-pointer justify-start text-sm gap-4 w-full !font-normal text-start rounded-full px-0" >
                  <div className="flex items-center gap-0 w-max rounded-md px-2 opacity-80 text-[#374151]  group-hover:bg-[#37415111] group-hover:opacity-100">
                    {/* <CurrencyDollarIcon className="w-5 text-[#39507f]" /> */}
                    {user?.role === "admin" ? (
            ...
            >
              <DropdownMenuItem>
                <div className=" relative cursor-pointer rounded-md flex items-center justify-between pr-4 text-sm h-8 w-full !font-normal text-start px-0 hover:bg-[#37415111]" >
                  <div className=" w-max px-2 opacity-80 text-[#374151] group-hover:opacity-100">{/* flex items-center gap-0 */}
          ...
          {/* <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                className="relative gap-4 h-8 w-full !font-normal text-start rounded-full px-0"
              >
                <div className="w-full px-2 py-1 rounded-md text-[#374151] opacity-[0.85] hover:bg-[#37415111]  hover:opacity-100">Editar imagen</div>
              </Button>
            </DropdownMenuTrigger>

            <DropdownMenuContent
              className="relative mt-3 bg-white left-2 -top-[232px] w-[300px] min-h-[272px] rounded-md shadow-xl shadow-[#30032222]"
              align="end"
              forceMount
            >
              <EditProfileImage user={user} />
...
//     <DropdownMenuContent
//       className="relative mt-1.5 bg-white w-[300px] ml-6 rounded-md shadow-xl shadow-[#30032222] sm:mt-3"
//       align="end"
//       forceMount
//     >
//       <EditProfileImage user={user} />
