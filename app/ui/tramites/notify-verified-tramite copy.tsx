...
export default function NotifyVerified() {
  ...
  return (
    <div
      className=" flex items-center w-[380px] mx-auto !shadow-[0_10px_20px_#b1c4e7]"
      aria-live="polite"
      aria-atomic="true"
    >
        <Frente 
          ...
          <form action={ formActionAuth } className="w-full">
            ...
            <button
                ...
                <p className="text-[14px] sm:text-[16px] text-[#ffffffdd] mb-3 font-medium [font-variant-caps:_small-caps]"> Correo Electrónico Verificado</p>

                <div className='flex items-center justify-center'>
                  <p className="text-[#ffffffdd] text-[13px] sm:text-[15px]">Continuar</p>
