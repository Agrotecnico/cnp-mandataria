...
import { updateTramite, StateUpdateTramite } from '@/app/lib/actions';
...
export default function EditTramiteForm({
  ...
  const [statex, formAction, isPending] = useActionState(updateTramiteWithId, initialState);
    ...
    <>
      <div className="flex flex-col justify-between rounded-xl ">
          ...
          <div className="flex items-center flex-nowrap gap-2 my-5 leading-tight">
            ...
            <div className="flex flex-wrap gap-2 items-center">
              ...
              <div className="flex gap-[1px] w-28 h-[14px] bg-[#ffffff] rounded-lg">
                ...
                <div className={`flex items-center justify-center text-[10px] text-center w-7  ${tramite.estado === "presupuestado" || tramite.estado === "iniciado" || tramite.estado === "cancelado" || tramite.estado === "terminado"  ? "bg-[#39507f] text-white" : "bg-white text-[#1d0215cc]" } `}>
                  2
                </div>
                <div className={`flex items-center justify-center text-[10px] text-center w-7 ${ tramite.estado === "iniciado" || tramite.estado === "cancelado" || tramite.estado === "terminado" ? "bg-[#39507f] text-white" : "bg-white text-[#1d0215cc]" } `}>
                  3
                </div>
                <div className={`flex items-center justify-center text-[10px] text-center w-7 ${ tramite.estado === "cancelado" || tramite.estado === "terminado"  ? "bg-[#39507f] text-white" : "bg-white text-[#1d0215cc]" } rounded-r-lg `}>
                  4
                </div>
              </div>
            </div>
        ...
        <Frente className="py-4 mb-4 px-4 text-sm sm:px-4" >
          ...
          <Disclosure>
            ...
            >
              <div className={`flex flex-wrap mt-0 mb-3 text-[#020b1dcc] gap-2 ${state && "mt-4"}`}>
                <div className="bg-[#020b1d] p-2 rounded-lg flex flex-col gap-2 flex-wrap justify-start sm:p-3">
            ...
            <div className="w-full items-start flex gap-3 justify-end sm:items-center sm:mb-0">
              <div className={`flex w-full text-[15px] sm:text-base `}>
                {tramite.estado === 'presupuestar' && (
                  <div className="flex ">
                    <div className={`mr-2 text-[12.5px] px-[8px] rounded-[4px] text-[#ffffff] bg-[#39507f]`}>2</div>Calcular el presupuesto
                  </div>
                )}
                {tramite.estado === 'presupuestado' && (
                  <div className="flex ">
                    <div className={`mr-2 text-[12.5px] px-[8px] rounded-[4px] text-[#ffffff] bg-[#39507f]`}>3</div>Chequear pago
                  </div>
                )}
                {tramite.estado === 'iniciado' && (
                  <div className="flex ">
                    <div className={`mr-2 text-[12.5px] px-[8px] rounded-[4px] text-[#ffffff] bg-[#39507f]`}>4</div>Trámite en ejecución
                  </div>
                )}
              </div>

              <Button
                className="relative h-[30px] rounded-md border border-[#d9dee8] min-h-[24px] w-[72px] justify-center bg-[#ffffffaa] !px-2.5 py-1 text-[13px] !font-normal text-[#020b1daa] hover:bg-[#ffffff] hover:text-[#020b1ddd] hover:border-[#c0c8d8] active:!bg-[#eee]"
                  ...
                  <fieldset>
                    <div className="rounded-md border-gray-200 bg-[#f7f7f700] px-[14px] py-3">
                      <div className="flex gap-8">
                        <div className={`relative border border-[#dbdbdb] rounded-lg flex items-center ${pago === "pagado" ? "bg-[#eaeaea] text-[#020b1d77]" : " text-[#020b1dcc] border-[#ff000028] bg-[#ff000014]"} hover:border-[#ff000038]`}>{/*  hover:text-[#020b1dcc] */}
                          <input
                            id="pendiente"
                            name="status"
                            type="radio"
                            ...
                            className="absolute hidden h-4 w-4 cursor-pointer border-gray-300 bg-gray-100 text-gray-600 focus:ring-2"
                            onChange={(e) => {
                        ...
                        <div className={`relative border rounded-lg flex items-center ${pago === "pendiente" ? "bg-[#eaeaea] text-[#1d021577] border-[#dbdbdb]" : " text-[#1d0215cc] border-[#22bb0038] bg-[#22bb0018]"} hover:border-[#1ba50258]`}>
                          <input
                            id="pagado"
                            name="status"
                            type="radio"
                          ...
                          <label
                            htmlFor="pagado"
                            className={`flex cursor-pointer items-center gap-1.5 rounded-lg px-3 py-1.5 text-sm font-medium `}
                          >
      ...
      <form action={formAction} >
        ...
        <div className="flex justify-end gap-4" >
          ...
          <ButtonA 
            type="submit" 
            className={`${tramite.estado === "cancelado" || tramite.estado === "terminado" && "hidden"} ${isPending && "before:absolute before:inset-0 before:-translate-x-full before:animate-[shimmer_1s_infinite] before:bg-gradient-to-r before:from-transparent before:via-white/30 before:to-transparent"}  relative overflow-hidden`}
            onClick={() => {
              handleClickButton()
            }}
